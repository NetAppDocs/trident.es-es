...
* 9 de mayo de 2925: link:https://community.netapp.com/t5/Tech-ONTAP-Blogs/Automatic-Trident-backend-configuration-for-FSx-for-ONTAP-with-the-Amazon-EKS/ba-p/460586["Configuración automática del backend de Trident para FSx para ONTAP con el complemento Amazon EKS"^]
