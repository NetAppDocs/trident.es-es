...
NOTE: También puedes usar formas alternativas para detectar fallas de nodos como se especifica en la sección de <<Integración de soluciones personalizadas de comprobación del estado de los nodos>> abajo.
