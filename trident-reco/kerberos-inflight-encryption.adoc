...
* *On-premise ONTAP* - Trident admite el cifrado Kerberos sobre NFSv3 y conexiones desde Red Hat OpenShift y clústeres upstream de Kubernetes a volúmenes ONTAP on-premise.
...
* Asegúrate de que cualquier volumen que uses con cifrado Kerberos esté configurado correctamente. Consulta la sección de configuración de dominio de NetApp (página 13) del https://www.netapp.com/media/16398-tr-3580.pdf["Guía de mejoras y mejores prácticas de NetApp"^].
...
Configura la política de exportación con NFS, NFSv3 y protocolos de acceso.
