...
* Se agregó soporte manual de QoS al controlador ANF, haciéndolo listo para producción en Trident 26.02; esta mejora experimental se introdujo en Trident 25.06.
