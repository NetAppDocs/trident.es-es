...
* Se corrigió que las aplicaciones de máquina virtual KubeVirt recrearan incorrectamente PersistentVolumeClaims durante las operaciones de reversa, resincronización inversa y resincronización de AppMirrorRelationship.
