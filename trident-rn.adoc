...
== ¿Cuáles son las novedades de 25,02

A partir de Trident 25,02, el nuevo resumen de los novedades proporciona detalles sobre mejoras, correcciones y bloqueos para versiones de Trident y Trident Protect.
...
** Se ha añadido la configuración de backend automática para el complemento EKS y la instalación basada en timón para Amazon FSx for NetApp ONTAP.
...
** Se ha añadido soporte para la virtualización de OpenShift para controladores ONTAP.
...
* Se agregó soporte de backup y restauración para máquinas virtuales de virtualización KubeVirt / OpenShift para el almacenamiento volumeMode: File y volumeMode: Bloque (dispositivo sin procesar) a la replicación de almacenamiento ya disponible a través de AppMirrorRelationship.
