...
** Se ha añadido compatibilidad con ONTAP ASA r2 para NVMe/TCP además de iSCSI. Verlink:link:https://docs.netapp.com/us-en/trident/trident-use/ontap-san-examples.html["Opciones y ejemplos de configuración DE SAN ONTAP"^] .
...
* Se ha corregido el tiempo de espera al clonar un volumen utilizando backends de SolidFire (link:https://github.com/NetApp/trident/issues/1008["Problema n.o 1008"] ).
