...
[%collapsible]
====
Para obtener más información sobre el desprendimiento forzado, consultelink:..trident-get-started/kubernetes-customize-deploy.html["Personalice la instalación del operador de Trident"] .
...
[%collapsible]
====
Para habilitar operaciones simultáneas del controlador Trident para un mejor rendimiento, agregue el `--enable-concurrency` opción durante la instalación como se muestra en este ejemplo.
