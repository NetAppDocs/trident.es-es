...
[role="lead"]
Si no estás ejecutando Trident 26.02, la documentación de las versiones anteriores está disponible según el link:get-help.html["Ciclo de vida del soporte de Trident"].
