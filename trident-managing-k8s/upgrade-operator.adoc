...
`bundle_pre_1_25.yaml` o `bundle_post_1_25.yaml` basado en su versión de Kubernetes. Por ejemplo, si está instalando Trident 25,06, ejecute el siguiente comando:
+
[listing]
----
...
.. Utilice `helm upgrade` el comando donde `trident-operator-25.06.0.tgz` refleja la versión a la que desea actualizar.
+
[listing]
----
