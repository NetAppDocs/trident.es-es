...
Cuando crea objetos de AppVault mediante CRS o el complemento de la CLI de Trident Protect, puede indicar a Trident Protect que utilice un secreto de Kubernetes que contenga contraseñas personalizadas para el cifrado del repositorio de Restic y KOPIA. Si no especifica un secreto, Trident Protect utiliza `password` ambas contraseñas.

* Al crear manualmente AppVault CRS, puede usar el campo *spec.properties.dataMoverPasswordSecretRef* para especificar el secreto.
...
----
--
.Utilice la interfaz de línea de comandos Trident Protect
--
[source, console]
----
