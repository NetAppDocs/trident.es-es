...
*Requisitos para la identidad del pod EKS con protección Trident *
...
* La función IAM está asociada con las siguientes cuentas de servicio de protección de Trident :
+
