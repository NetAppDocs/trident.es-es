...
NOTE: Al restaurar un backup en un espacio de nombres con recursos existentes, no se alterará ningún recurso que comparta los nombres con los que aparecen en el backup. Para restaurar todos los recursos de un backup, elimine y vuelva a crear el espacio de nombres de destino, o restaure el backup en un nuevo espacio de nombres.
