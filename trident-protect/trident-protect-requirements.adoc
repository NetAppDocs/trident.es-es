...
* Asegúrese de que exista al menos una VolumeSnapshotClass. Para obtener más información, consultelink:https://docs.netapp.com/us-en/trident_main/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"] .
