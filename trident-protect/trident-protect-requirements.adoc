...
* Asegúrate de que existe al menos un VolumeSnapshotClass. Para más información, consulta link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
...
----
====
Para saber cómo definir aplicaciones y restaurar máquinas virtuales con Trident Protect, consulta link:trident-protect-kubevirt-vms.html["Protege las máquinas virtuales de KubeVirt con Trident Protect"].
