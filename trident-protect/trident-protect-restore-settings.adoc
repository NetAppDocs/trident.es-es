...
summary: Puede personalizar las operaciones de restauración de Trident Protect mediante anotaciones, configuraciones de espacio de nombres y opciones de almacenamiento. 
---
