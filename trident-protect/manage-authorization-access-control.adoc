...
summary: 'Trident Protect utiliza el modelo Kubernetes de control de acceso basado en roles (RBAC).  Puede utilizar las funciones RBAC de Trident Protect para controlar con mayor precisión el acceso a los recursos.' 
---
