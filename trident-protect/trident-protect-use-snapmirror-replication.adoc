...
. Realice los pasos de resincronización inversa en <<Reverse resync a failed over replication>>.
...
* Realice una resincronización inversa de la relación.
* Invierta la replicación.


.Pasos
. Realice <<Resync a failed over replication>>los pasos
. Realice <<Reverse resync a failed over replication>>los pasos
