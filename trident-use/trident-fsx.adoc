...
** Trident solo admite volúmenes SMB montados en pods que se ejecutan en nodos Windows. Consulta link:worker-node-prep.html#prepare-to-provision-smb-volumes["Prepárese para aprovisionar los volúmenes de SMB"] para más detalles.
