...
----
. Continúa con la configuración y configura el backend de almacenamiento. Para más información, consulta link:trident-fsx-storage-backend.html["Configure el backend de almacenamiento"].
