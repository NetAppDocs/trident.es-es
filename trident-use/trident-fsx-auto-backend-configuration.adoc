...
Para obtener una lista completa de los parámetros de backend, consulta: xref:trident-fsx-storage-backend.html#backend-advanced-configuration-and-examples[Configuración del backend de FSx para NetApp ONTAP].
