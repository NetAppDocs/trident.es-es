...
NOTE: Trident utiliza backends separados para cargas de trabajo NAS y SAN en Google Cloud NetApp Volumes. El `google-cloud-netapp-volumes` backend admite solo protocolos basados en archivos y no se puede utilizar para aprovisionar volúmenes iSCSI.


NOTE: Para aprovisionar volúmenes de bloques iSCSI, usa el 
