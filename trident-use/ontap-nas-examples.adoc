...
| `limitAggregateUsage` | Fallará el aprovisionamiento si el uso supera este porcentaje. *No se aplica a Amazon FSx para ONTAP*. | "" (no se aplica de forma predeterminada) 
