...
[role="lead"]
Si bien link:../trident-managing-k8s/tridentctl.html["comandos y opciones de trimentctl"] son la forma más sencilla de interactuar con la API de REST de Trident, puedes usar el endpoint REST directamente si lo prefieres.
